...
L["targets"] = "cibles"
L["Highlight player"] = "Mettre en surbrillance le joueur"
L["If true, highlight the player's name in a different color"] = "Si vrai, mettez en surbrillance le nom du joueur dans une couleur différente"
L["Player highlight color"] = "Couleur de surbrillance du joueur"
L["If 'Highlight player' is enabled, this determines the color of the player's name"] = "Si 'Highlight player' est activé, cela détermine la couleur du nom du joueur"
L["Data update frequency"] = "Fréquence de mise à jour des données"
L["How many times per second the data view will be updated"] = "Combien de fois par seconde la vue des données sera mise à jour"
