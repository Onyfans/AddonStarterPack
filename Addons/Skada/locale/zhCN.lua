...
-- L["targets"] = ""
L["Highlight player"] = "突出播放器"
L["If true, highlight the player's name in a different color"] = "如果为真，则以不同的颜色突出显示玩家的名字"
L["Player highlight color"] = "播放器高亮颜色"
L["If 'Highlight player' is enabled, this determines the color of the player's name"] = "如果启用了“突出显示播放器”，这将确定播放器名称的颜色"
L["Data update frequency"] = "数据更新频率"
L["How many times per second the data view will be updated"] = "数据视图每秒更新多少次"
