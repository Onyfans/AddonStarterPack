...
L["targets"] = "цели"
L["Highlight player"] = "Выделить игрока"
L["If true, highlight the player's name in a different color"] = "Если верно, выделить имя игрока другим цветом"
L["Player highlight color"] = "Цвет подсветки плеера"
L["If 'Highlight player' is enabled, this determines the color of the player's name"] = "Если включено «Выделить игрока», это определяет цвет имени игрока."
L["Data update frequency"] = "Частота обновления данных"
L["How many times per second the data view will be updated"] = "Сколько раз в секунду будет обновляться представление данных"
