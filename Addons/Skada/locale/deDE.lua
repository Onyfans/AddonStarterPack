...
L["targets"] = "ziele"
L["Highlight player"] = "Spieler hervorheben"
L["If true, highlight the player's name in a different color"] = "Wenn wahr, markieren Sie den Namen des Spielers in einer anderen Farbe"
L["Player highlight color"] = "Hervorhebungsfarbe des Spielers"
L["If 'Highlight player' is enabled, this determines the color of the player's name"] = "Wenn 'Spieler hervorheben' aktiviert ist, bestimmt dies die Farbe des Spielernamens"
L["Data update frequency"] = "Häufigkeit der Datenaktualisierung"
L["How many times per second the data view will be updated"] = "Wie oft pro Sekunde wird die Datenansicht aktualisiert"
