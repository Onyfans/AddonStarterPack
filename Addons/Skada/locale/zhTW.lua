...
L["If true, highlight the player's name in a different color"] = "如果為真，則以不同的顏色突出顯示玩家的名字"
L["Player highlight color"] = "播放器高亮顏色"
L["If 'Highlight player' is enabled, this determines the color of the player's name"] = "如果啟用了“突出顯示播放器”，這將確定播放器名稱的顏色"
L["Data update frequency"] = "數據更新頻率"
L["How many times per second the data view will be updated"] = "數據視圖每秒更新多少次"
